    ...
    <form className="border p-5 shadow rounded-4">
      ...
      <div className="row mt-3">
        <div className="col-12 col-md-6 col-lg-4">
          <Input id={"employeeFullName"} label={"الاسم رباعي"} type={"text"} />
        </div>
        <div className="col-12 col-md-6 col-lg-4">
      ...
      <button className="col-12 col-md-6 col-lg-4 mt-3 mt-md-0 btn btn-custom btn-lg" type="submit">اضافة الموظف</button>
      </div>
    </form>
  );
}
